      ...
      <Content sideNav={false}>
        <div className={AboutCSS.aboutPage}>
          ...
          <section className={AboutCSS.sectionStyle}>
            ...
            <p className={AboutCSS.paragraphStyle}>Kindest regards,<br/>your neighbour</p>
          </section>
          <section className={AboutCSS.sectionStyle}>
            <h2 className={AboutCSS.headerStyle}>What if you don't keep cash on hand?</h2>
            <p className={AboutCSS.paragraphStyle}>Consider giving the Wealthsimple Cash app a try. Canada's fastest and simplest way to send and receive money. No fees and totally secure. You can get a free $10 if you sign up with <a href="https://my.wealthsimple.com/app/public/cash-referral-signup?handle=$lamarelimbo" target="_blank" className={AboutCSS.linkStyle} rel="noreferrer">my referral link</a>.</p>
